...
const faqs = [
  ...
  { q: "Quel abonnement IPTV choisir à Daloa pour les Grands Championnats ?", a: "L'offre 2 mois à 5 900 FCFA couvre toute la durée du tournoi (jusqu'au 19 juillet). Pour un meilleur prix à long terme, l'offre 3 mois à 7 900 FCFA est la plus populaire à Daloa (soit 2 633 FCFA/mois)." },
