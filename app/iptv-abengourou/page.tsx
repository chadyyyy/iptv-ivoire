...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "IPTV Abengourou 2026 — 22 840 Chaînes 4K, Wave & Orange Money",
    description: "Le meilleur service IPTV à Abengourou. Paiement sécurisé Wave & Orange Money, activation rapide. Agnikro, Plateau, Cafétou, Lobikro, Adaou et tous les quartiers.",
    url: 'https://iptvivoire.com/iptv-abengourou',
    images: [{ url: 'https://iptvivoire.com/cities/abengourou.jpg', width: 1200, height: 630, alt: "IPTV Abengourou — Ville d'Abengourou dans la région de l'Indénié-Djuablin" }],
  },
}

const faqs = [
  { q: "L'IPTV fonctionne-t-il bien à Abengourou avec la connexion mobile ?", a: "Oui, notre service est parfaitement optimisé pour la 4G/5G d'Orange, MTN et Moov à Abengourou. Dans les quartiers comme Agnikro, Plateau, et Cafétou, le débit est excellent et permet de regarder des chaînes en HD/4K de manière fluide sans interruption." },
  { q: "Comment payer mon abonnement IPTV à Abengourou ?", a: "Vous pouvez payer directement via Wave ou Orange Money. C'est rapide, sans frais supplémentaires, et l'activation se fait en 5 minutes après validation sur WhatsApp." },
  ...
  { q: "Est-ce compatible avec les box Android et Smart TV à Abengourou ?", a: "Absolument. Notre service est compatible avec les téléviseurs connectés (Samsung, LG, Hisense), Box Android TV, téléphones, ordinateurs et tablettes. Nous vous fournissons un guide complet d'installation sur WhatsApp." },
  ...
  { q: "Quels sont les tarifs de l'IPTV à Abengourou ?", a: "Nos forfaits : Offre 2 mois à 5 900 FCFA, 3 mois à 7 900 FCFA, et l'abonnement annuel (13 mois) à seulement 24 900 FCFA." },
...
export default function IPTVAbengourouPage() {
  const faqSchema = getFAQSchema(faqs.map(f => ({ question: f.q, answer: f.a })))
  const breadcrumbSchema = getBreadcrumbSchema([
    { name: 'Accueil', url: 'https://iptvivoire.com' },
    { name: 'IPTV Abengourou', url: 'https://iptvivoire.com/iptv-abengourou' },
  ])
  const productSchema = getProductSchema({
    name: 'IPTV Abengourou — Abonnement 3 mois',
    price: '7900',
    description: "IPTV Abengourou 3 mois à 7 900 FCFA. 22 840 chaînes HD/4K, VOD 124 580 films. Wave & Orange Money. Activation en 5 min.",
  })
  const localBizSchema = {
    '@context': 'https://schema.org', '@type': 'LocalBusiness',
    name: 'IPTV Ivoire — Abengourou', url: 'https://iptvivoire.com/iptv-abengourou',
    image: 'https://iptvivoire.com/cities/abengourou.jpg',
    priceRange: '5900-24900 FCFA', currenciesAccepted: 'XOF',
    paymentAccepted: 'Orange Money, Wave, MTN MoMo, Moov Money',
    areaServed: { '@type': 'City', name: 'Abengourou', containedInPlace: { '@type': 'Country', name: "Côte d'Ivoire" } },
    address: { '@type': 'PostalAddress', addressCountry: 'CI', addressLocality: 'Abengourou' },
        ...
        <div className="ab">
          ...
          <section className="ab-hero">
            <div>
              ...
              <h1>IPTV Abengourou : <span className="grad">22 840 Chaînes en 4K</span>, Sans Coupure et Sécurisé (2026)</h1>
              <p>Profitez du meilleur de la télévision par internet à Abengourou. Toutes vos chaînes de sport et films préférés en qualité Ultra HD. Activation rapide 100% à distance.</p>
              ...
              <div className="ab-cta-row">
                <a href={`${WHATSAPP_URL}&text=Bonjour, je veux un essai gratuit IPTV Abengourou`} target="_blank" rel="noopener noreferrer" className="ab-btn ab-btn-primary">⚡ Essai Gratuit 24h</a>
                <a href={`${WHATSAPP_URL}&text=Bonjour, je veux commander un forfait IPTV Abengourou`} target="_blank" rel="noopener noreferrer" className="ab-btn ab-btn-wa">💬 Commander via WhatsApp</a>
              </div>
            </div>
            <div style={{ display: 'flex', justifyContent: 'center' }}>
              <Image src="/cities/abengourou.jpg" alt="IPTV Abengourou — Ville d'Abengourou dans la région de l'Indénié-Djuablin" width={500} height={333} priority style={{ objectFit: 'cover' }} />
            </div>
          </section>
          ...
          {/* ── 3. INTRO ── */}
          <section>
            <span className="eyebrow">IPTV Abengourou</span>
            <h2>Le leader du streaming IPTV à Abengourou et dans l&apos;Indénié-Djuablin</h2>
            <p>Abengourou, capitale royale de l&apos;Indénié, connaît elle aussi une révolution dans le domaine du divertissement télévisuel. Finies les perturbations fréquentes des antennes satellites lors des intempéries de la saison des pluies. Grâce aux réseaux de données 4G d&apos;Orange, MTN et Moov, la technologie IPTV vous offre une qualité d&apos;image d&apos;une stabilité inédite en haute définition et en 4K.</p>
            <p>Notre service **Stream-Stable™** avec technologie anti-freeze avancée assure une fluidité totale lors de la retransmission des événements sportifs les plus attendus de l&apos;année, y compris l&apos;intégralité de la Coupe du Monde 2026. Du quartier historique d&apos;Agnikro au Plateau, en passant par Cafétou et Lobikro, nos clients profitent d&apos;une expérience de visionnage haut de gamme sans aucun ralentissement.</p>
          </section>
          ...
          <section>
            ...
            <p>Notre abonnement IPTV Abengourou regroupe le meilleur du divertissement mondial et africain :</p>
            <ul>
            ...
            <div className="ab-plans">
              <div className="ab-plan-card">
                ...
                <div className="ab-plan-cta">
                  <a href={`${WHATSAPP_URL}&text=Bonjour, je veux commander le forfait 2 mois à 5900 FCFA pour Abengourou`} target="_blank" rel="noopener noreferrer" className="ab-btn ab-btn-primary" style={{ width: '100%' }}>Commander via WhatsApp</a>
                </div>
              </div>
              ...
              <div className="ab-plan-card featured">
                ...
                <div className="ab-plan-cta">
                  <a href={`${WHATSAPP_URL}&text=Bonjour, je veux commander le forfait 3 mois à 7900 FCFA pour Abengourou`} target="_blank" rel="noopener noreferrer" className="ab-btn ab-btn-primary" style={{ width: '100%' }}>Commander via WhatsApp</a>
                </div>
              </div>
              ...
              <div className="ab-plan-card">
                ...
                <div className="ab-plan-cta">
                  <a href={`${WHATSAPP_URL}&text=Bonjour, je veux commander le forfait annuel à 24900 FCFA pour Abengourou`} target="_blank" rel="noopener noreferrer" className="ab-btn ab-btn-primary" style={{ width: '100%' }}>Commander via WhatsApp</a>
                </div>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <p>Pour s&apos;adapter aux besoins de nos clients à Abengourou, nous acceptons les principaux réseaux de paiement mobile de Côte d&apos;Ivoire :</p>
            <ol>
          ...
          <section className="ab-testimonials">
            ...
            <h2>Ce que disent nos clients à Abengourou</h2>
            <div className="ab-test-grid">
              <div className="ab-test-card">
                <span className="ab-test-stars">★★★★★</span>
                <p>&ldquo;Le streaming est super stable sur ma box Android ici à Agnikro. J&apos;ai pu payer par MTN MoMo sur WhatsApp, et le technicien m&apos;a aidé à tout configurer à distance en 5 minutes. Un service client au top !&rdquo;</p>
                <div className="ab-test-user">
                  <div className="ab-test-avatar">A</div>
                  <div className="ab-test-meta">
                    <b>Aka M.</b>
                    <span>Agnikro, Abengourou</span>
                  </div>
                </div>
              </div>
              ...
              <div className="ab-test-card">
                <span className="ab-test-stars">★★★★★</span>
                <p>&ldquo;Paiement Wave super pratique et sans frais. L&apos;activation a pris moins de 3 minutes. Je regarde RTI 1 et Canal+ en qualité parfaite depuis Adaou. Je recommande vivement IPTV Ivoire.&rdquo;</p>
                <div className="ab-test-user">
                  <div className="ab-test-avatar">B</div>
                  <div className="ab-test-meta">
                    <b>Bamba T.</b>
                    <span>Adaou, Abengourou</span>
                  </div>
                </div>
              </div>
          ...
          <section id="ab-faq">
            ...
            <h2>Questions fréquentes — IPTV Abengourou</h2>
          ...
          <section className="ab-final">
            <h2>Prêt à regarder l&apos;IPTV à Abengourou ?</h2>
            ...
            <div className="ab-cta-row" style={{ justifyContent: 'center' }}>
              <a href={`${WHATSAPP_URL}&text=Bonjour, je veux un abonnement IPTV à Abengourou`} target="_blank" rel="noopener noreferrer" id="abengourou-final-cta" className="ab-btn ab-btn-wa">💬 Activer mon IPTV à Abengourou</a>
