...
export const metadata: Metadata = {
  ...
  description: "Guides complets sur l'IPTV en Côte d'Ivoire. Installation, paiement Orange Money et Wave, Grands Championnats, comparatifs et actualités IPTV.",
  alternates: {
