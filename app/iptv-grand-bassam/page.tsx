...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "IPTV Grand-Bassam 2026 — 22 840 Chaînes 4K, Wave & Orange Money",
    description: "Le meilleur service IPTV à Grand-Bassam. Paiement sécurisé Wave & Orange Money, activation rapide. Quartier de France, Petit Paris, Rosiers, Impérial et tous les secteurs.",
    url: 'https://iptvivoire.com/iptv-grand-bassam',
    images: [{ url: 'https://iptvivoire.com/cities/grand-bassam.jpg', width: 1200, height: 630, alt: "IPTV Grand-Bassam — Ville historique de Grand-Bassam" }],
  },
}

const faqs = [
  { q: "L'IPTV fonctionne-t-il bien à Grand-Bassam avec la proximité de la mer ?", a: "Oui, notre service est parfaitement optimisé pour la fibre optique locale et la 4G/5G d'Orange, MTN et Moov à Grand-Bassam. Dans les secteurs comme le Quartier de France, Petit Paris, et les Rosiers, le débit est excellent et permet de regarder des chaînes en HD/4K de manière fluide sans interruption." },
  { q: "Comment payer mon abonnement IPTV à Grand-Bassam ?", a: "Vous pouvez payer directement via Wave ou Orange Money. C'est rapide, sans frais supplémentaires, et l'activation se fait en 5 minutes après validation sur WhatsApp." },
  ...
  { q: "Est-ce compatible avec les box Android et Smart TV à Grand-Bassam ?", a: "Absolument. Notre service est compatible avec les téléviseurs connectés (Samsung, LG, Hisense), Box Android TV, téléphones, ordinateurs et tablettes. Nous vous fournissons un guide complet d'installation sur WhatsApp." },
  ...
  { q: "Quels sont les tarifs de l'IPTV à Grand-Bassam ?", a: "Nos forfaits : Offre 2 mois à 5 900 FCFA, 3 mois à 7 900 FCFA, et l'abonnement annuel (13 mois) à seulement 24 900 FCFA." },
...
export default function IPTVGrandBassamPage() {
  const faqSchema = getFAQSchema(faqs.map(f => ({ question: f.q, answer: f.a })))
  const breadcrumbSchema = getBreadcrumbSchema([
    { name: 'Accueil', url: 'https://iptvivoire.com' },
    { name: 'IPTV Grand-Bassam', url: 'https://iptvivoire.com/iptv-grand-bassam' },
  ])
  const productSchema = getProductSchema({
    name: 'IPTV Grand-Bassam — Abonnement 3 mois',
    price: '7900',
    description: "IPTV Grand-Bassam 3 mois à 7 900 FCFA. 22 840 chaînes HD/4K, VOD 124 580 films. Wave & Orange Money. Activation en 5 min.",
  })
  const localBizSchema = {
    '@context': 'https://schema.org', '@type': 'LocalBusiness',
    name: 'IPTV Ivoire — Grand-Bassam', url: 'https://iptvivoire.com/iptv-grand-bassam',
    image: 'https://iptvivoire.com/cities/grand-bassam.jpg',
    priceRange: '5900-24900 FCFA', currenciesAccepted: 'XOF',
    paymentAccepted: 'Orange Money, Wave, MTN MoMo, Moov Money',
    areaServed: { '@type': 'City', name: 'Grand-Bassam', containedInPlace: { '@type': 'Country', name: "Côte d'Ivoire" } },
    address: { '@type': 'PostalAddress', addressCountry: 'CI', addressLocality: 'Grand-Bassam' },
        ...
        <div className="ab">
          ...
          <section className="ab-hero">
            <div>
              ...
              <h1>IPTV Grand-Bassam : <span className="grad">22 840 Chaînes en 4K</span>, Sans Coupure et Sécurisé (2026)</h1>
              <p>Profitez du meilleur de la télévision par internet à Grand-Bassam. Toutes vos chaînes de sport et films préférés en qualité Ultra HD. Activation rapide 100% à distance.</p>
              ...
              <div className="ab-cta-row">
                <a href={`${WHATSAPP_URL}&text=Bonjour, je veux un essai gratuit IPTV Grand-Bassam`} target="_blank" rel="noopener noreferrer" className="ab-btn ab-btn-primary">⚡ Essai Gratuit 24h</a>
                <a href={`${WHATSAPP_URL}&text=Bonjour, je veux commander un forfait IPTV Grand-Bassam`} target="_blank" rel="noopener noreferrer" className="ab-btn ab-btn-wa">💬 Commander via WhatsApp</a>
              </div>
            </div>
            <div style={{ display: 'flex', justifyContent: 'center' }}>
              <Image src="/cities/grand-bassam.jpg" alt="IPTV Grand-Bassam — Ville historique de Grand-Bassam" width={500} height={333} priority style={{ objectFit: 'cover' }} />
            </div>
          </section>
          ...
          {/* ── 3. INTRO ── */}
          <section>
            <span className="eyebrow">IPTV Grand-Bassam</span>
            <h2>Le service de streaming IPTV de référence à Grand-Bassam</h2>
            <p>Grand-Bassam, la ville historique et touristique classée à l&apos;UNESCO, profite pleinement de la modernisation des infrastructures télécoms. Grâce à l&apos;arrivée de la fibre optique et à la puissance du réseau 4G d&apos;Orange, MTN et Moov, regarder la télévision par internet n&apos;a jamais été aussi simple et stable.</p>
            <p>Notre service **Stream-Stable™** avec technologie anti-freeze avancée assure une fluidité totale lors de la retransmission des événements sportifs les plus attendus de l&apos;année, y compris l&apos;intégralité de la Coupe du Monde 2026. Du célèbre Quartier de France au secteur de Petit Paris, en passant par l&apos;Impérial et la zone des Rosiers, nos abonnés bénéficient d&apos;une expérience cinéma et sport haut de gamme à la maison.</p>
          </section>
          ...
          <section>
            ...
            <p>Notre abonnement IPTV Grand-Bassam regroupe le meilleur du divertissement mondial et africain :</p>
            <ul>
            ...
            <div className="ab-plans">
              <div className="ab-plan-card">
                ...
                <div className="ab-plan-cta">
                  <a href={`${WHATSAPP_URL}&text=Bonjour, je veux commander le forfait 2 mois à 5900 FCFA pour Grand-Bassam`} target="_blank" rel="noopener noreferrer" className="ab-btn ab-btn-primary" style={{ width: '100%' }}>Commander via WhatsApp</a>
                </div>
              </div>
              ...
              <div className="ab-plan-card featured">
                ...
                <div className="ab-plan-cta">
                  <a href={`${WHATSAPP_URL}&text=Bonjour, je veux commander le forfait 3 mois à 7900 FCFA pour Grand-Bassam`} target="_blank" rel="noopener noreferrer" className="ab-btn ab-btn-primary" style={{ width: '100%' }}>Commander via WhatsApp</a>
                </div>
              </div>
              ...
              <div className="ab-plan-card">
                ...
                <div className="ab-plan-cta">
                  <a href={`${WHATSAPP_URL}&text=Bonjour, je veux commander le forfait annuel à 24900 FCFA pour Grand-Bassam`} target="_blank" rel="noopener noreferrer" className="ab-btn ab-btn-primary" style={{ width: '100%' }}>Commander via WhatsApp</a>
                </div>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <p>Pour s&apos;adapter aux besoins de nos clients à Grand-Bassam, nous acceptons les principaux réseaux de paiement mobile de Côte d&apos;Ivoire :</p>
            <ol>
          ...
          <section className="ab-testimonials">
            ...
            <h2>Ce que disent nos clients à Grand-Bassam</h2>
            <div className="ab-test-grid">
              <div className="ab-test-card">
                <span className="ab-test-stars">★★★★★</span>
                <p>&ldquo;Le streaming est super stable sur ma box Android ici au Quartier de France. J&apos;ai pu payer par Wave sur WhatsApp et l&apos;activation s&apos;est faite en 3 minutes. Aucun freeze sur le sport.&rdquo;</p>
                <div className="ab-test-user">
                  <div className="ab-test-avatar">A</div>
                  <div className="ab-test-meta">
                    <b>Anoma J.</b>
                    <span>Quartier de France, Grand-Bassam</span>
                  </div>
                </div>
              </div>
              ...
              <div className="ab-test-card">
                <span className="ab-test-stars">★★★★★</span>
                <p>&ldquo;Paiement Orange Money super pratique. Le technicien sur WhatsApp m&apos;a aidé à configurer ma Smart TV LG en 5 minutes. Très pro et réactif.&rdquo;</p>
                <div className="ab-test-user">
                  <div className="ab-test-avatar">M</div>
                  <div className="ab-test-meta">
                    <b>Mensah E.</b>
                    <span>Petit Paris, Grand-Bassam</span>
                  </div>
                </div>
              </div>
              ...
              <div className="ab-test-card">
                <span className="ab-test-stars">★★★★★</span>
                <p>&ldquo;L&apos;offre de 12 mois est incroyable. Toutes les chaînes de sport françaises et les chaînes ivoiriennes comme la RTI fonctionnent sans soucis à la maison.&rdquo;</p>
                <div className="ab-test-user">
                  <div className="ab-test-avatar">N</div>
                  <div className="ab-test-meta">
                    <b>N&apos;Guessan P.</b>
                    <span>Rosiers, Grand-Bassam</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <section id="ab-faq">
            ...
            <h2>Questions fréquentes — IPTV Grand-Bassam</h2>
          ...
          <section className="ab-final">
            <h2>Prêt à regarder l&apos;IPTV à Grand-Bassam ?</h2>
            ...
            <div className="ab-cta-row" style={{ justifyContent: 'center' }}>
              <a href={`${WHATSAPP_URL}&text=Bonjour, je veux un abonnement IPTV à Grand-Bassam`} target="_blank" rel="noopener noreferrer" id="bassam-final-cta" className="ab-btn ab-btn-wa">💬 Activer mon IPTV à Grand-Bassam</a>
