...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "IPTV San Pedro 2026 — 22 840 Chaînes 4K, Wave & Orange Money",
    description: "Le meilleur service IPTV à San Pedro. Paiement sécurisé Wave & Orange Money, activation rapide. Bardot, Séwéké, Zimbabwe, Balmer et tous les quartiers.",
    url: 'https://iptvivoire.com/iptv-san-pedro',
    images: [{ url: 'https://iptvivoire.com/cities/san-pedro.jpg', width: 1200, height: 630, alt: "IPTV San Pedro — Ville et port de San Pedro" }],
  },
}

const faqs = [
  { q: "L'IPTV fonctionne-t-il bien à San Pedro avec Orange ou MTN ?", a: "Oui, notre service est parfaitement optimisé pour les réseaux 4G/5G Orange CI, MTN et Moov à San Pedro. Une vitesse de 10 Mbps suffit pour la HD et 25 Mbps pour la 4K. Des secteurs comme Balmer, Cité, Lac et le Centre-ville offrent d'excellentes vitesses." },
  { q: "Comment payer mon IPTV à San Pedro ?", a: "Contactez-nous sur WhatsApp, indiquez le forfait de votre choix, puis réglez en quelques secondes par Wave, Orange Money ou MTN MoMo. Votre compte est activé sous 5 minutes." },
  { q: "L'IPTV est-il disponible dans tous les quartiers de San Pedro ?", a: "Oui, notre couverture s'étend sur tout San Pedro : Bardot, Séwéké, Zimbabwe, Centre-ville, Balmer, Nanhio, Cité, Lac, Colline, etc." },
  { q: "Puis-je regarder RTI 1 et RTI 2 depuis San Pedro ?", a: "Absolument. Notre abonnement inclut toutes les chaînes locales de Côte d'Ivoire (RTI 1, RTI 2, La 3, NCI, Life TV, A+ Ivoire) ainsi que les bouquets internationaux comme beIN Sports et Canal+." },
  { q: "Sur quels appareils puis-je utiliser mon IPTV à San Pedro ?", a: "Le service est compatible avec les Smart TV (Samsung, LG, Sony, Hisense), Box Android, smartphones (Android & iOS), tablettes et ordinateurs. Nous vous guidons pas à pas pour l'installation sur WhatsApp." },
  { q: "Quel abonnement IPTV choisir à San Pedro pour les Grands Championnats ?", a: "L'offre 2 mois à 5 900 FCFA couvre toute la durée du tournoi (jusqu'au 19 juillet). Pour un meilleur prix à long terme, l'offre 3 mois à 7 900 FCFA est la plus populaire à San Pedro (soit 2 633 FCFA/mois)." },
  { q: "Quelle connexion internet est requise à San Pedro ?", a: "Une simple connexion internet stable (Fibre, Box 4G ou Mobile) de 10 Mbps suffit pour de la HD fluide, et 25 Mbps pour le flux 4K." },
]

export default function IPTVSanPedroPage() {
  const faqSchema = getFAQSchema(faqs.map(f => ({ question: f.q, answer: f.a })))
  const breadcrumbSchema = getBreadcrumbSchema([
    { name: 'Accueil', url: 'https://iptvivoire.com' },
    { name: 'IPTV San Pedro', url: 'https://iptvivoire.com/iptv-san-pedro' },
  ])
  const productSchema = getProductSchema({
    name: 'IPTV San Pedro — Abonnement 3 mois',
    price: '7900',
    description: "IPTV San Pedro 3 mois à 7 900 FCFA. 22 840 chaînes HD/4K, VOD 124 580 films. Wave & Orange Money. Activation en 5 min.",
  })
  const localBizSchema = {
    '@context': 'https://schema.org', '@type': 'LocalBusiness',
    name: 'IPTV Ivoire — San Pedro', url: 'https://iptvivoire.com/iptv-san-pedro',
    image: 'https://iptvivoire.com/cities/san-pedro.jpg',
    priceRange: '5900-24900 FCFA', currenciesAccepted: 'XOF',
    paymentAccepted: 'Orange Money, Wave, MTN MoMo, Moov Money',
    areaServed: { '@type': 'City', name: 'San Pedro', containedInPlace: { '@type': 'Country', name: "Côte d'Ivoire" } },
    address: { '@type': 'PostalAddress', addressCountry: 'CI', addressLocality: 'San Pedro' },
        ...
        <div className="ab">
          ...
          <section className="ab-hero">
            <div>
              <div className="ab-rating">
                <span className="ab-stars">★★★★★</span> 4,9/5 — Service N°1 à San Pedro
              </div>
              <h1>IPTV San Pedro : <span className="grad">22 840 Chaînes en 4K</span>, Sans Coupure et Sécurisé (2026)</h1>
              <p>Marre des coupures en plein match ? Découvrez l&apos;<strong>IPTV San Pedro</strong> de référence : paiement sécurisé Wave & Orange Money, activation immédiate et support WhatsApp 24/7.</p>
              ...
              <div className="ab-cta-row">
                ...
                <a href={`${WHATSAPP_URL}&text=Bonjour, je veux un abonnement IPTV à San Pedro`} className="ab-btn ab-btn-wa" target="_blank" rel="noopener noreferrer">💬 Commander sur WhatsApp</a>
              </div>
              <div className="ab-hero-note">🔒 Paiement sécurisé Wave & Orange Money — activation en 5 minutes.</div>
            </div>
            <div style={{ position: 'relative' }}>
              <Image src="/cities/san-pedro.jpg" alt="IPTV San Pedro — Ville et port de San Pedro" width={540} height={360} style={{ width: '100%', borderRadius: '20px', boxShadow: '0 30px 70px rgba(0,0,0,.5)' }} priority />
            </div>
          </section>
          ...
          <section className="ab-trust">
            <div className="ab-trust-grid">
              ...
              <div className="ab-trust-cell"><div className="ab-trust-ico">👥</div><div><b>3 420 clients CI</b><span>À San Pedro et partout en CI</span></div></div>
          ...
          <section>
            <div className="ab-tldr">
              ...
              <ul>
                <li>L&apos;<strong>IPTV à San Pedro</strong> donne accès à 22 840 chaînes et 124 580 films via internet, sans parabole.</li>
                ...
                <li>Disponible dans <strong>tous les quartiers de San Pedro</strong> : Bardot, Séwéké, Zimbabwe, Balmer, Cité, Lac, etc.</li>
              </ul>
            </div>
            <p>San Pedro, premier port exportateur de cacao au monde et pôle économique majeur du Sud-Ouest de la Côte d&apos;Ivoire, bénéficie d&apos;une excellente couverture réseau. Grâce à la fibre et à la 4G Orange et MTN, regarder la télévision en streaming est devenu simple et fluide. C&apos;est précisément ce que propose notre offre <strong>IPTV San Pedro</strong> : une télévision moderne, riche en chaînes de sport et de cinéma, accessible sans matériel lourd.</p>
          ...
          <section>
            <div className="ab-toc">
              <h3>📖 Sommaire</h3>
              <ol>
                <li><a href="#ab-quoi">Qu&apos;est-ce que l&apos;IPTV à San Pedro ?</a></li>
                <li><a href="#ab-pourquoi">Pourquoi l&apos;IPTV séduit à San Pedro</a></li>
                ...
                <li><a href="#ab-avis">Avis de nos clients San Pedro</a></li>
          ...
          <section id="ab-quoi">
            ...
            <h2>Qu&apos;est-ce que l&apos;IPTV et comment ça marche à San Pedro ?</h2>
            <p>L&apos;IPTV est la technologie qui diffuse les chaînes de télévision en utilisant le protocole internet. Contrairement aux abonnements satellites classiques, l&apos;IPTV n&apos;exige pas l&apos;installation d&apos;une parabole extérieure, sensible aux intempéries marines fréquentes dans la région de San Pedro. Vous avez simplement besoin d&apos;une connexion internet stable et d&apos;une application de lecture.</p>
            <div className="ab-callout warn">
              <p>💡 <b>Bon à savoir :</b> Une connexion de 10 Mbps suffit pour la HD et 25 Mbps pour la 4K. La 4G à San Pedro offre largement ces performances dans la plupart des secteurs.</p>
            </div>
            <h3>L&apos;IPTV San Pedro, secteur par secteur</h3>
            <p>Notre service est pleinement fonctionnel dans tous les quartiers de San Pedro, de la zone résidentielle de <strong>Balmer</strong> au grand quartier de <strong>Bardot</strong>, en passant par <strong>Séwéké</strong>, <strong>Zimbabwe</strong>, la <strong>Cité</strong>, le <strong>Lac</strong>, <strong>Colline</strong> et <strong>Nanhio</strong>.</p>
          </section>

          {/* ── 7. WHY IPTV ── */}
          <section id="ab-pourquoi">
            <span className="eyebrow">Les avantages</span>
            <h2>Pourquoi l&apos;IPTV séduit autant les habitants de San Pedro</h2>
          ...
          <section id="ab-contenus">
            ...
            <h2>Que pouvez-vous regarder avec l&apos;IPTV à San Pedro ?</h2>
          ...
          <section id="ab-arnaque">
            ...
            <h2>Évitez les fraudes IPTV à San Pedro</h2>
            <div className="ab-vs">
          ...
          <section id="ab-compare">
            ...
            <h2>IPTV Ivoire vs Satellite à San Pedro</h2>
            <div className="ab-tw">
          ...
          <section id="ab-install">
            ...
            <h2>Comment s&apos;abonner à San Pedro en 5 étapes</h2>
          ...
          <section id="ab-appareils">
            ...
            <h2>Appareils compatibles à San Pedro</h2>
          ...
          <section id="ab-avis">
            ...
            <h2>Ce que disent nos clients à San Pedro</h2>
            <div className="ab-revs">
              {[
                { init: 'G', name: 'Gnahoré P.', loc: 'Balmer, San Pedro', stars: '★★★★★', text: "Super stable sur ma Smart TV LG avec la fibre. Le paiement par Wave est rapide et sécurisé. Aucun freeze pendant les matchs !" },
                { init: 'S', name: 'Sylla L.', loc: 'Séwéké, San Pedro', stars: '★★★★★', text: "Service client au top sur WhatsApp. L'installateur m'a aidé à configurer mon abonnement sur ma box Android en 5 minutes." },
                { init: 'K', name: 'Koffi J.', loc: 'Centre-ville, San Pedro', stars: '★★★★★', text: "Le catalogue VOD de plus de 124 580 films et séries est impressionnant. Très bon rapport qualité-prix." },
              ].map(r => (
          ...
          <section id="ab-tarifs">
            ...
            <h2>Choisissez votre abonnement IPTV San Pedro</h2>
            <div className="ab-pricing">
              {[
                { name: '2 mois', sub: 'Grands Championnats', price: '5 900 FCFA', orig: '7 800 FCFA', promo: '-24% — Offre Découverte', feat: false,
                  ...
                  wa: `${WHATSAPP_URL}&text=Bonjour, je veux l'abonnement IPTV 2 mois (5900 FCFA) à San Pedro` },
                { name: '3 mois', sub: 'Le plus populaire à San Pedro', price: '7 900 FCFA', orig: '11 700 FCFA', promo: '-32% — Le + choisi', feat: true,
                  items: ['Matchs CDM 2026', '22 840 chaînes HD/4K', 'RTI + beIN Sports + TF1', 'VOD 124 580 films', 'Support prioritaire', 'Activation en 5 min'],
                  wa: `${WHATSAPP_URL}&text=Bonjour, je veux l'abonnement IPTV 3 mois (7900 FCFA) à San Pedro` },
                { name: '12 mois + 1 offert', sub: 'Meilleur rapport qualité/prix', price: '24 900 FCFA', orig: '35 900 FCFA', promo: '-30% — 13 mois complets', feat: false,
                  ...
                  wa: `${WHATSAPP_URL}&text=Bonjour, je veux l'abonnement IPTV annuel (24900 FCFA) à San Pedro` },
              ].map(p => (
          ...
          <section id="ab-faq">
            ...
            <h2>Questions fréquentes — IPTV San Pedro</h2>
          ...
          <section className="ab-final">
            <h2>Prêt à regarder l&apos;IPTV à San Pedro ?</h2>
            ...
            <div className="ab-cta-row" style={{ justifyContent: 'center' }}>
              <a href={`${WHATSAPP_URL}&text=Bonjour, je veux un abonnement IPTV à San Pedro`} target="_blank" rel="noopener noreferrer" id="sanpedro-final-cta" className="ab-btn ab-btn-wa">💬 Activer mon IPTV à San Pedro</a>
