...
export const metadata: Metadata = {
  ...
  description: "IPTV Yamoussoukro : +22 000 chaînes en 4K. Paiement Orange Money & Wave, prix en FCFA, activation en 5 min. Fonctionne à Centre-ville, Habitat, N'Zuessy, Dioulakro.",
  ...
  openGraph: {
    title: "IPTV Yamoussoukro 2026 — +22 000 Chaînes 4K, Orange Money & Wave",
    description: "Le meilleur service IPTV à Yamoussoukro. Paiement sécurisé Orange Money & Wave, activation rapide. Centre-ville, Habitat, N'Zuessy, Dioulakro et tous les quartiers.",
    url: 'https://iptvivoire.com/iptv-yamoussoukro',
    images: [{ url: 'https://iptvivoire.com/cities/yamoussoukro.jpg', width: 1200, height: 630, alt: "IPTV Yamoussoukro — Basilique et ville de Yamoussoukro" }],
  },
}

const faqs = [
  { q: "L'IPTV fonctionne-t-il bien à Yamoussoukro avec Orange ou MTN ?", a: "Oui, notre service est parfaitement optimisé pour les réseaux 4G Orange CI, MTN et Moov à Yamoussoukro. Une connexion de 10 Mbps suffit pour la HD et 25 Mbps pour la 4K. Des zones comme Sopim, N'Zuessy, Millionnaire et le Centre-ville offrent d'excellentes débits." },
  { q: "Comment payer mon IPTV à Yamoussoukro ?", a: "Contactez-nous sur WhatsApp, indiquez le forfait souhaité, puis effectuez votre paiement sécurisé via Wave, Orange Money ou MTN MoMo. Vos codes d'accès vous sont transmis sous 5 minutes." },
  { q: "L'IPTV est-il disponible dans tous les quartiers de Yamoussoukro ?", a: "Oui, le service couvre tout Yamoussoukro : Centre-ville, Quartier Habitat, N'Zuessy, Dioulakro, Morofé, Assabou, Kokrenou, Sopim, Millionnaire, 220 Logements, et les environs." },
  { q: "Puis-je regarder RTI 1 et RTI 2 depuis Yamoussoukro ?", a: "Absolument. Notre offre inclut RTI 1, RTI 2, La 3, NCI, Life TV, A+ Ivoire, ainsi que les chaînes sportives (Canal+ Sport, beIN Sports) et les grands bouquets mondiaux." },
  { q: "Sur quels appareils puis-je installer mon IPTV à Yamoussoukro ?", a: "Le service est compatible avec toutes les Smart TV (Samsung, LG, Sony, Hisense), Box Android TV, smartphones (iPhone & Android), tablettes et PC/Mac. Nous vous assistons sur WhatsApp pour la configuration." },
  { q: "Quel abonnement IPTV choisir à Yamoussoukro pour la Coupe du Monde ?", a: "Le forfait Coupe du Monde de 2 mois à 5 900 FCFA couvre l'intégralité du Mondial 2026. L'offre de 3 mois à 7 900 FCFA est la plus demandée pour son excellent rapport qualité-prix (2 633 FCFA/mois)." },
  { q: "Quelle vitesse internet faut-il pour l'IPTV à Yamoussoukro ?", a: "Une connexion de 10 Mbps est idéale pour le Full HD sans coupure. La 4G locale ou une connexion fibre permet d'avoir une excellente fluidité, même lors des grands matchs en direct." },
]

export default function IPTVMariageYamoussoukroPage() {
  const faqSchema = getFAQSchema(faqs.map(f => ({ question: f.q, answer: f.a })))
  const breadcrumbSchema = getBreadcrumbSchema([
    { name: 'Accueil', url: 'https://iptvivoire.com' },
    { name: 'IPTV Yamoussoukro', url: 'https://iptvivoire.com/iptv-yamoussoukro' },
  ])
  const productSchema = getProductSchema({
    name: 'IPTV Yamoussoukro — Abonnement 3 mois',
    price: '7900',
    description: "IPTV Yamoussoukro 3 mois à 7 900 FCFA. +22 000 chaînes HD/4K, VOD 120 000+ films. Orange Money & Wave. Activation en 5 min.",
  })
  const localBizSchema = {
    '@context': 'https://schema.org', '@type': 'LocalBusiness',
    name: 'IPTV Ivoire — Yamoussoukro', url: 'https://iptvivoire.com/iptv-yamoussoukro',
    image: 'https://iptvivoire.com/cities/yamoussoukro.jpg',
    priceRange: '5900-24900 FCFA', currenciesAccepted: 'XOF',
    paymentAccepted: 'Orange Money, Wave, MTN MoMo, Moov Money',
    areaServed: { '@type': 'City', name: 'Yamoussoukro', containedInPlace: { '@type': 'Country', name: "Côte d'Ivoire" } },
    address: { '@type': 'PostalAddress', addressCountry: 'CI', addressLocality: 'Yamoussoukro' },
    ...
    <>
      ...
      <main style={{ paddingBottom: '2rem' }}>
        <div className="ab">
          ...
          <section className="ab-hero">
            <div>
              <div className="ab-rating">
                <span className="ab-stars">★★★★★</span> 4,9/5 — Service N°1 à Yamoussoukro
              </div>
              <h1>IPTV Yamoussoukro : <span className="grad">+22 000 Chaînes en 4K</span>, Sans Coupure et Sécurisé (2026)</h1>
              <p>Profitez de la télévision sans limite. Découvrez l&apos;<strong>IPTV Yamoussoukro</strong> de référence : paiement local sécurisé par Orange Money & Wave, activation immédiate et support client sur WhatsApp.</p>
              ...
              <div className="ab-cta-row">
                ...
                <a href={`${WHATSAPP_URL}&text=Bonjour, je veux un abonnement IPTV à Yamoussoukro`} className="ab-btn ab-btn-wa" target="_blank" rel="noopener noreferrer">💬 Commander sur WhatsApp</a>
              </div>
              <div className="ab-hero-note">🔒 Paiement sécurisé Orange Money & Wave — codes envoyés en 5 minutes.</div>
            </div>
            <div style={{ position: 'relative' }}>
              <Image src="/cities/yamoussoukro.jpg" alt="IPTV Yamoussoukro — Basilique Notre-Dame de la Paix à Yamoussoukro" width={540} height={360} style={{ width: '100%', borderRadius: '20px', boxShadow: '0 30px 70px rgba(0,0,0,.5)' }} priority />
            </div>
          </section>
          ...
          <section className="ab-trust">
            <div className="ab-trust-grid">
              ...
              <div className="ab-trust-cell"><div className="ab-trust-ico">👥</div><div><b>3 000+ clients CI</b><span>À Yamoussoukro et en CI</span></div></div>
          ...
          <section>
            <div className="ab-tldr">
              ...
              <ul>
                <li>L&apos;<strong>IPTV à Yamoussoukro</strong> offre un accès direct à +22 000 chaînes et 120 000 films et séries via internet.</li>
                <li>Paiement pratique et sécurisé via <strong>Orange Money</strong>, <strong>Wave</strong> ou MTN MoMo en moins de 30 secondes.</li>
                <li>Forfaits adaptés à tous les budgets : dès 5 900 FCFA pour 2 mois. Pas de contrat ni d&apos;engagement.</li>
                <li>Une installation facile sur tous les écrans : Smart TV, Box, téléphones et tablettes.</li>
                <li>Couverture totale dans <strong>toutes les zones de Yamoussoukro</strong> : Centre-ville, Sopim, N&apos;Zuessy, Millionnaire, etc.</li>
              </ul>
            </div>
            <p>Yamoussoukro, la capitale politique et administrative de la Côte d&apos;Ivoire, est une ville en pleine expansion connectée aux réseaux haut débit. Pour de nombreux foyers, l&apos;IPTV est devenue la solution préférée pour remplacer la télévision par satellite traditionnelle. Plus besoin d&apos;antenne sur le toit : une simple connexion internet suffit pour capter vos programmes de sport, divertissement et actualité en haute définition.</p>
            <p>Découvrez ci-dessous comment notre service <strong>IPTV Yamoussoukro</strong> transforme votre expérience télévisuelle, notre grille tarifaire claire en FCFA, et notre processus d&apos;activation rapide.</p>
          </section>
          ...
          <section>
            <div className="ab-toc">
              <h3>📖 Sommaire</h3>
              <ol>
                <li><a href="#ab-quoi">Qu&apos;est-ce que l&apos;IPTV à Yamoussoukro ?</a></li>
                <li><a href="#ab-pourquoi">Pourquoi l&apos;IPTV séduit à Yamoussoukro</a></li>
                ...
                <li><a href="#ab-avis">Avis de nos clients à Yamoussoukro</a></li>
          ...
          <section id="ab-quoi">
            ...
            <h2>Qu&apos;est-ce que l&apos;IPTV et comment ça marche à Yamoussoukro ?</h2>
            <p>L&apos;IPTV (Internet Protocol Television) est un système moderne qui diffuse la télévision par internet. Contrairement aux décodeurs par parabole qui nécessitent un pointage satellite précis, l&apos;IPTV reçoit le signal vidéo sous forme de données via votre connexion ADSL, fibre ou réseau mobile 4G. Vous n&apos;avez besoin d&apos;aucun équipement physique en dehors de votre écran habituel.</p>
            <div className="ab-callout warn">
              <p>💡 <b>À retenir :</b> Une vitesse de 10 Mbps suffit pour la Full HD, et 25 Mbps pour la 4K Ultra HD. La 4G d&apos;Orange CI et de MTN à Yamoussoukro couvre la quasi-totalité de la ville avec d&apos;excellents débits pour un streaming très fluide.</p>
            </div>
            <h3>Avantages de l&apos;IPTV sur le satellite à Yamoussoukro</h3>
            <p>Le satellite est coûteux à installer et subit d&apos;importantes perturbations lors de la saison des pluies dans la région des Lacs. L&apos;IPTV s&apos;affranchit de ces contraintes météo et matérielles. Vous profitez d&apos;une qualité d&apos;image parfaite en HD et 4K, sans aucune parabole extérieure.</p>
            <h3>L&apos;IPTV Yamoussoukro, quartier par quartier</h3>
            <p>Nous desservons tous les secteurs et quartiers de Yamoussoukro : du <strong>Centre-ville</strong> au quartier <strong>Millionnaire</strong>, en passant par <strong>N&apos;Zuessy</strong>, <strong>Dioulakro</strong>, <strong>Quartier Habitat</strong>, <strong>Morofé</strong>, <strong>Assabou</strong>, <strong>Kokrenou</strong>, <strong>Sopim</strong> et <strong>220 Logements</strong>. Quel que soit votre quartier, la réception est rapide et immédiate dès activation de vos codes.</p>
          </section>

          {/* ── 7. WHY IPTV ── */}
          <section id="ab-pourquoi">
            <span className="eyebrow">Les avantages</span>
            <h2>Pourquoi l&apos;IPTV séduit autant les habitants de Yamoussoukro</h2>
            <p>Yamoussoukro est une ville étudiante et administrative dynamique. Ses résidents apprécient d&apos;avoir un accès complet à l&apos;actualité nationale et internationale, aux grands événements sportifs et à un catalogue cinématographique complet, le tout réuni au sein d&apos;une offre simple et abordable en FCFA.</p>
          ...
          <section id="ab-contenus">
            ...
            <h2>Que pouvez-vous regarder avec l&apos;IPTV à Yamoussoukro ?</h2>
            <h3>Un catalogue de sport exceptionnel</h3>
            <ul>
              <li>Football européen et mondial : Ligue 1, Premier League, Liga, Serie A, Champions League.</li>
              <li>Coupe du Monde 2026 : l&apos;intégralité des 64 matchs retransmis sur nos chaînes dédiées en UHD.</li>
              <li>Autres disciplines : NBA, Formule 1, Tennis, combats de MMA.</li>
            </ul>
            <h3>Les chaînes d&apos;Afrique francophone</h3>
            <ul>
              <li>Les médias ivoiriens : RTI 1, RTI 2, La 3, NCI, Life TV, A+ Ivoire.</li>
              <li>Les chaînes de la sous-région (Sénégal, Mali, Cameroun) ainsi que Canal+ Afrique.</li>
            </ul>
            <h3>Divertissement et cinéma mondial</h3>
            <ul>
              <li>Chaînes françaises complètes (TF1, France 2, M6, Canal+ France) et chaînes jeunesse.</li>
              <li>Accès à notre vidéothèque VOD de +120 000 films, séries et documentaires en français.</li>
            </ul>
          </section>
          ...
          <section id="ab-arnaque">
            ...
            <h2>Attention aux arnaques IPTV à Yamoussoukro : comment acheter en sécurité</h2>
            <p>Méfiez-vous des profils anonymes sur Facebook ou Telegram qui vous proposent des tarifs dérisoires sur des périodes très longues. Il s&apos;agit souvent de ventes frauduleuses où le service s&apos;arrête après quelques jours sans recours possible. Chez IPTV Ivoire, nous garantissons un paiement local officiel et un support client continu sur WhatsApp.</p>
            <div className="ab-vs">
              <div className="ab-panel ab-danger">
                <h3>🚩 Les signaux d&apos;un arnaqueur</h3>
                <ul>
                  <li>Un tarif annuel anormalement bas (ex. : 3 000 FCFA).</li>
                  <li>Aucun support technique après réception de l&apos;argent.</li>
                  <li>Pas de site internet ni de traces officielles de l&apos;activité.</li>
                  <li>Insistance pour obtenir un transfert rapide sans test préalable.</li>
                </ul>
              </div>
              <div className="ab-panel ab-safe">
                <h3>✅ Notre engagement de confiance</h3>
                <ul>
                  <li>Grille tarifaire claire et affichée publiquement.</li>
                  <li>Paiement officiel via Orange Money ou Wave.</li>
                  <li>Support WhatsApp francophone réactif sous 5 minutes.</li>
                  <li>Aide à l&apos;installation incluse pour tous les clients.</li>
                  <li>Plus de 3 000 clients réguliers satisfaits en Côte d&apos;Ivoire.</li>
                </ul>
              </div>
            </div>
            <div className="ab-callout">
              <p>💚 <b>Notre promesse :</b> Nous sécurisons votre transaction. Vos accès vous sont envoyés par message en quelques minutes, et notre équipe vous aide à configurer vos applications en cas de besoin.</p>
            </div>
          </section>
          ...
          <section id="ab-compare">
            ...
            <h2>IPTV Ivoire vs Canal+ vs StarSat à Yamoussoukro</h2>
            <div className="ab-tw">
          ...
          <section id="ab-install">
            ...
            <h2>Comment activer votre IPTV à Yamoussoukro en 5 étapes</h2>
          ...
          <section id="ab-appareils">
            ...
            <h2>Sur quels appareils regarder l&apos;IPTV à Yamoussoukro ?</h2>
            <div className="ab-cards">
              ...
              <div className="ab-card"><span className="ic">📱</span><h3>Smartphones & Tablettes</h3><p>Android (Samsung, Xiaomi, Tecno, Infinix) et iPhone/iPad — regardez partout, même en déplacement dans Yamoussoukro.</p></div>
              <div className="ab-card"><span className="ic">📦</span><h3>Android TV Box</h3><p>Transformer n&apos;importe quelle télévision en Smart TV IPTV. Compatible avec toutes les box Android disponibles à Yamoussoukro.</p></div>
          ...
          <section id="ab-avis">
            ...
            <h2>Ce que disent nos clients à Yamoussoukro</h2>
            <div className="ab-revs">
              {[
                { init: 'K', name: 'Kouamé T.', loc: "N'Zuessy, Yamoussoukro", stars: '★★★★★', text: "Vraiment au top. Payé par Orange Money, activé en 5 min par WhatsApp. Les films et séries VOD sont en très bonne qualité, pas besoin de chercher ailleurs." },
                { init: 'D', name: 'Diallo M.', loc: 'Dioulakro, Yamoussoukro', stars: '★★★★★', text: "J'utilise le service sur ma Smart TV Samsung avec la 4G MTN. Aucun problème pour regarder les matchs de foot, le serveur est très stable." },
                { init: 'N', name: "N'Dri A.", loc: 'Millionnaire, Yamoussoukro', stars: '★★★★★', text: "Prix en FCFA super intéressant, support très rapide en français. J'ai pris l'abonnement 12 mois et je ne le regrette pas." },
              ].map(r => (
          ...
          <section id="ab-tarifs">
            ...
            <h2>Choisissez votre abonnement IPTV Yamoussoukro</h2>
            ...
            <div className="ab-pricing">
              {[
                { name: '2 mois', sub: 'Coupe du Monde 2026', price: '5 900 FCFA', orig: '7 800 FCFA', promo: '-24% — Offre CDM', feat: false,
                  ...
                  wa: `${WHATSAPP_URL}&text=Bonjour, je veux l'abonnement IPTV 2 mois (5900 FCFA) à Yamoussoukro` },
                { name: '3 mois', sub: 'Le plus populaire à Yamoussoukro', price: '7 900 FCFA', orig: '11 700 FCFA', promo: '-32% — Le + choisi', feat: true,
                  ...
                  wa: `${WHATSAPP_URL}&text=Bonjour, je veux l'abonnement IPTV 3 mois (7900 FCFA) à Yamoussoukro` },
                { name: '12 mois + 1 offert', sub: 'Meilleur rapport qualité/prix', price: '24 900 FCFA', orig: '35 900 FCFA', promo: '-30% — 13 mois complets', feat: false,
                  ...
                  wa: `${WHATSAPP_URL}&text=Bonjour, je veux l'abonnement IPTV annuel (24900 FCFA) à Yamoussoukro` },
              ].map(p => (
            ...
            <div className="ab-seal" style={{ marginTop: '2rem' }}>
              ...
              <div>
                <h3>Paiement 100% sécurisé à Yamoussoukro — Orange Money & Wave</h3>
                <p>Chaque transaction est enregistrée de manière transparente et traçable. Les accès d&apos;abonnement vous sont délivrés sur WhatsApp sous 5 minutes. Support client et assistance à distance offerts.</p>
              </div>
            </div>
          </section>
          ...
          <section id="ab-faq">
            ...
            <h2>Questions fréquentes — IPTV Yamoussoukro</h2>
          ...
          <section className="ab-final">
            <h2>Prêt à regarder l&apos;IPTV à Yamoussoukro ?</h2>
            ...
            <div className="ab-cta-row" style={{ justifyContent: 'center' }}>
              <a href={`${WHATSAPP_URL}&text=Bonjour, je veux un abonnement IPTV à Yamoussoukro`} target="_blank" rel="noopener noreferrer" id="yamoussoukro-final-cta" className="ab-btn ab-btn-wa">💬 Activer mon IPTV à Yamoussoukro</a>
        ...
        <div className="ab-sticky">
          ...
          <a href={`${WHATSAPP_URL}&text=Bonjour, je veux un abonnement IPTV à Yamoussoukro`} target="_blank" rel="noopener noreferrer" className="s-wa">💬 WhatsApp</a>
        </div>
      </main>
      <Footer />
    </>
